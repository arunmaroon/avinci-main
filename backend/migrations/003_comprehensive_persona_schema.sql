-- Comprehensive Persona Schema - Short vs Full View Model
-- This migration implements the complete persona specification with short/full views
...
CREATE INDEX IF NOT EXISTS idx_agents_profile_embedding ON agents USING ivfflat (profile_embedding vector_cosine_ops);
CREATE INDEX IF NOT EXISTS idx_sessions_agent_id ON sessions(agent_id);
CREATE INDEX IF NOT EXISTS idx_sessions_status ON sessions(status);
CREATE INDEX IF NOT EXISTS idx_messages_session_id ON messages(session_id);
CREATE INDEX IF NOT EXISTS idx_messages_embedding ON messages USING ivfflat (message_embedding vector_cosine_ops);
