            ...
            if (type === 'group') {
                try {
                    ...
                    if (groupResponse.data && Array.isArray(groupResponse.data)) {
                        ...
                        // Emit multiple responses with delays
                        groupResponse.data.forEach((response, index) => {
                            setTimeout(() => {
                                const roomName = `call-${callId}`;
                                console.log(`🎭 Emitting agent response ${index + 1}:`, response.agentName);
                                ...
                                // Then emit the response after a short delay
                                setTimeout(() => {
                                    ...
                                    console.log(`✅ Agent response ${index + 1} sent to room: ${roomName}`);
